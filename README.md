...
- Peptides (9–12-mers) were generated from Annexin (anx) and the full K. pneumoniae (kp) proteome.
- One set of peptides were generated without any rule HLA-B27 anchor rules on the other hand another set were generated by applying HLA anchor rule:
  **Peptide length: 9–10 amino acids
  P1: small residue
  P2: positively charged (Arg, Lys)
  C-terminal (PΩ): hydrophobic/aromatic (Leu, Phe, Tyr, Met, Val, Trp, Ile)**
- Tools: Biopython  
...
- **KP1** showed the closest behavior to ANX in:
  ...
  → **we can suggest it as mimic candidate** but further investigation or experimental validation will be required.
